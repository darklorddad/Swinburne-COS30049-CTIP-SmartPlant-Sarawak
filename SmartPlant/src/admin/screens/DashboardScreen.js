      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.iotContainer}>
          ...
          <Text style={styles.iotSubtitle}>
            View live sensor readings, radar sweep, motion and sound events in real time.
          </Text>
          ...
          <View style={styles.iotChipsRow}>
            ...
            <View style={[styles.iotChip, { backgroundColor: '#ecfeff' }]}>
              <Text style={styles.iotChipText}>Temperature and Humidity</Text>
            </View>
            <View style={[styles.iotChip, { backgroundColor: '#f0fdf4' }]}>
              <Text style={styles.iotChipText}>Motion and Sound Events</Text>
            </View>
          </View>
        </View>
