...
**2.3 How well do you think you doing/progressing? (Reflect is there a gap? What is it?)**
...
**State what have done to achieve the learning outcomes below in your learning process:**
...
I had to make critical decisions regarding the technology stack. For the AI, I evaluated frameworks like PyTorch versus TensorFlow and selected the one best suited for our data type. For the dashboard, I organised the component structure to ensure reusability and maintainability, deciding on a modular architecture.

**ULO4 Use technology to develop and present innovation solutions.**
I utilised Python libraries (Pandas, Scikit-Learn) for data manipulation and model training. For the dashboard, I used modern web frameworks to create the interface. I used Git for version control to manage the codebase and integrated RESTful APIs to allow the dashboard to communicate seamlessly with the AI model.

**ULO5 Demonstrate reflective practice, and use self and peer evaluation.**
I regularly reviewed my code against industry standards (such as PEP8 for Python). I actively sought feedback on the dashboard UX from teammates, which led to a redesign of the navigation bar to improve accessibility and usability.

**ULO6 Communicate within teams and stakeholders using appropriate verbal, written and technological approaches.**
I documented the API endpoints using standard documentation tools so teammates could understand how to interact with the admin dashboard. During stand-ups, I communicated technical challenges regarding the dashboard's data visualisation and user management features, translating them into clear progress updates for non-technical stakeholders.
...
The process of hyperparameter tuning. It was fascinating to observe how tweaking learning rates or batch sizes directly impacted the model's convergence and final accuracy. Visualising this data on the dashboard made the abstract math tangible.

**I feel I learnt these topics, concepts, and/or tools really well:**
I have gained a strong command of Python for data science (specifically Pandas and NumPy) and the integration of backend logic with frontend dashboards. My understanding of API design patterns has improved significantly through connecting the two components.

**I still need to work on the following areas:**
I need to improve my understanding of frontend state management for complex dashboards. While the AI logic is sound, the frontend code could be more optimised to prevent unnecessary re-renders.
...
**Other:**
Working on the admin dashboard gave me a better appreciation for User Experience (UX) design, highlighting that a powerful AI model is useless if the interface to control it is unintuitive.
